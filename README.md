# An ongoing experiment for more impactful data teams and for accelerated growth in companies
...
## Solution
- A derived "formula" of the business using only metrics with correlation to each other and the key business metrics
